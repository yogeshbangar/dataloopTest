...
distortionPass.uniforms.k1.value = -0.2;    // Negative = barrel
distortionPass.uniforms.k2.value = 0.1;
distortionPass.uniforms.k3.value = -0.05;
distortionPass.uniforms.p1.value = 0.001;   // Tangential distortion
distortionPass.uniforms.p2.value = 0.001;
distortionPass.uniforms.scale.value = 1.0;
distortionPass.uniforms.inverse.value = false;

// Pincushion distortion
distortionPass.uniforms.k1.value = 0.1;     // Positive = pincushion
distortionPass.uniforms.k2.value = -0.05;
distortionPass.uniforms.k3.value = 0.02;

// Strong fisheye (GoPro-like)
distortionPass.uniforms.k1.value = -0.3;
distortionPass.uniforms.k2.value = 0.12;
distortionPass.uniforms.k3.value = -0.03;
distortionPass.uniforms.p1.value = 0.002;
distortionPass.uniforms.p2.value = 0.001;

// To undistort/correct fisheye footage:
distortionPass.uniforms.inverse.value = true;
